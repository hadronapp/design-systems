export default {
  ...
  homepage: 'https://bulma.io/documentation/elements/table',
};

export const variants = [
  {
    displayName: 'Simple Table. Striped',
    picture: {
      src: './pictures/table/simple-table-striped.webp',
      width: 147,
      height: 210,
    },
    snippet: {
  ...
  {
    displayName: 'Full Table Example',
    picture: {
      src: './pictures/table/full-example.webp',
      width: 984,
      height: 897,
    },
    snippet: {
